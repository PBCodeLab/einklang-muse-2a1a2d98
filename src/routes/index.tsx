        ...
        <div className={MAX}>
          <div className="max-w-5xl mb-20">
            ...
            <p className="txt-body whitespace-pre-line">
              ...
              We overcome these accessibility, affordability and sustainability challenges with by making them available in scalable AI agents. But we don't just scale the classic methods: We evolve them for the AI-native era, so that the guide our clients towards AI-native operational excellence.
            </p>
          </div>
